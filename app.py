...
# Set your secret key
app.config['SECRET_KEY'] = '970ecd2a24360cb8839a852742d9bf61'

# Config MySQL
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:iamroot@localhost/myflaskapp'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

# Init MySQL
mysql = SQLAlchemy(app, session_options={"autoflush": False})

# The rest of your routes and app configuration
